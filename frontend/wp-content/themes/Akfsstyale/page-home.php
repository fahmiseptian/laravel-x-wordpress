    ...
    <nav class="navbar">
        ...
        <ul class="menu">
            <?php if (function_exists('pll_current_language') && pll_current_language() == 'id') : ?>
                <li><a href="<?php echo get_permalink(get_page_by_path('beranda')); ?>" class="<?php echo 'active'; ?>"><img src="<?php echo get_template_directory_uri() . '/assets/icons/beranda.png' ?>" alt="icon"> Beranda</a></li>
                ...
                <li><a href="<?php echo get_permalink(get_page_by_path('units-affiliates')); ?>" class="<?php if (is_page('units-affiliates')) echo 'active'; ?>"><img src="<?php echo get_template_directory_uri() . '/assets/icons/units.png' ?>" alt="icon"> Unit & Afiliasi</a></li>
                <li><a href="<?php echo get_permalink(get_page_by_path('activity')); ?>" class="<?php if (is_page('activity')) echo 'active'; ?>"><img src="<?php echo get_template_directory_uri() . '/assets/icons/activity.png' ?>" alt="icon"> Aktivitas</a></li>
                <li><a href="<?php echo get_permalink(get_page_by_path('contact')); ?>" class="<?php if (is_page('contact')) echo 'active'; ?>"><img src="<?php echo get_template_directory_uri() . '/assets/icons/cs.png' ?>" alt="icon"> Kontak</a></li>
            <?php else : ?>
                <li><a href="<?php echo get_permalink(get_page_by_path('home')); ?>" class="<?php echo 'active'; ?>"><img src="<?php echo get_template_directory_uri() . '/assets/icons/beranda.png' ?>" alt="icon"> Home</a></li>
...
<main>
    ...
    <p>Ini adalah halaman activity.</p>
</main>
