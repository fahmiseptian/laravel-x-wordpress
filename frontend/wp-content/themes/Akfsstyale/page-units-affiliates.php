...
<header>
    <nav class="navbar">
        ...
        <ul class="menu2">
            ...
            <li><a href="<?php echo get_permalink(get_page_by_path('activity')); ?>" class="<?php if (is_page('activity')) echo 'active'; ?>"><img src="<?php echo get_template_directory_uri() . '/assets/icons/activity-merah.png' ?>" alt="icon"> Activity</a></li>
